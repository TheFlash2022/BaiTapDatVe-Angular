...
let BaiTapDatGheComponent = class BaiTapDatGheComponent {
    constructor() {
        this.chairList = [
    ...
    handleRemove(chair) {
        const idx = this.findChairIndex(chair);
        this.selectedChairList.splice(idx, 1);
        this.gheComponents.forEach((gheComponent) => {
            if (gheComponent.chair.SoGhe === chair.SoGhe) {
                gheComponent.isSelectedChair = false;
            }
        });
    }
    findChairIndex(chair) {
        return this.selectedChairList.findIndex((ele) => ele.SoGhe === chair.SoGhe);
    }
};
__decorate([
    ViewChildren(GheComponent)
], BaiTapDatGheComponent.prototype, "gheComponents", void 0);
BaiTapDatGheComponent = __decorate([
    Component({
        selector: "app-bai-tap-dat-ghe",
        template: `<div class="w-50 mt-5 mx-auto">
    <h1 class="text-warning tex-center py-3">Bài Tập Đặt Ghế</h1>
    <div class="row">
      <div class="col-6">
        <h5 class="py-2 bg-dark text-white text-center">TÀI XẾ</h5>
...
export { BaiTapDatGheComponent };
//# sourceMappingURL=bai-tap-dat-ghe.component.js.map